...
The invoice money fields are `baseFee`, `overtimeAmount`, and `totalDue`.
The duplicate aliases `planFee`, `totalOvertimeFee`, and `grandTotal` were
removed from the API contract; frontend code must use the canonical fields.
